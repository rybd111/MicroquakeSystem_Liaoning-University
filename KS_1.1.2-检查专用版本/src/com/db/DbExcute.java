	...
	public ResultSet Query_3_5(String sql) {
		try {
			...
			while (resultSet.next()) {
				Tools_DataCommunication.getCommunication().dataList.add(
					new TableData(
						resultSet.getString("id"),
						resultSet.getString("quackTime"),  
						...
						new QuackResults(
							resultSet.getDouble("xData"), 
							resultSet.getDouble("yData"),
							resultSet.getDouble("zData"), 
							resultSet.getString("quackTime"),
							resultSet.getDouble("quackGrade"), 
							resultSet.getDouble("Parrival"),
							resultSet.getString("panfu"), 
							resultSet.getDouble("duringGrade"),
							resultSet.getDouble("nengliang"), 
							resultSet.getString("wenjianming"), 
							resultSet.getDouble("tensor"), 
							resultSet.getString("kind"), 
...
//		}
	...
	public void Query_panel(String sql) {
		...
		try {
			 ...
			 */
			while (resultSet.next()) {
				Tools_DataCommunication.getCommunication().dataList_QueryPanel.add(
					new TableData(
						resultSet.getString("id"), 
						resultSet.getString("quackTime"), 
						resultSet.getString("kind"), 
